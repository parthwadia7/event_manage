...
<head>
    ...
    <style>
        ...
        .input-forget td label {
            width: 100%;
            text-align: left;
            display: block;
        }

        .input-forget td input {
            width: 100%;
            border: 0;
            border-bottom: 1px solid #57c0d3;
        }
                        ...
                        <table>
                            ...
                            <tr class="input-forget">
                                <td>
                                    ...
                                    <input name="password" type="password" id="txtPassword" title="Password must contain: Minimum 8 characters atleast 1 Alphabet and 1 Number and 1 special character"
                                             required pattern="^(?=.*[0-9])(?=.*[a-z])(?=.*[a-z])(?=\S+$).{8,}$" />
                                    <!--<input type="password" name="password" class="form-control" value="{{old('password')}}"  required/>-->
                                    
                                    {!!$errors->first("password", "<span class='text-danger'>:message at least one lowercase letter,one digit minimum,one special character</span>")!!}
                                </td>
                            </tr>
                            <tr class="input-forget">
                                <td>
                                <label>
                                    ...
                                    <input type="password" name="confirm_password" id="txtConfirmPassword" class="form-control" value="{{old('confirm_password')}}"  required="" />
                            ...
                            <tr class="forget-button">
                                <td>
                                    <p class="custom-button" style="text-align: center;">
                                        ...
                                        <!-- <a href="#" class="btn btn-primary">Confirmer le nouveau mot de passe</a> -->
                                    </p>
                                </td>
                            </tr>
                        </table>
